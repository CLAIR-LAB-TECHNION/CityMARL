...
from MARL_algs.SACD_policies import Actor, CnnPolicy, MlpPolicy, MultiInputPolicy, SACPolicy,\
    MultiPerspectivePolicy,MultiPerspectiveCritic
        ...
        for gradient_step in range(gradient_steps):
            ...
            if ent_coef_loss is not None and self.ent_coef_optimizer is not None:
                ...
                with th.no_grad():
                    ...
                    index_tensor = indices_q_values.squeeze()

                    stacked_tensor = th.stack(self.critic_target(replay_data.next_observations, next_actions))
                    next_q_values = stacked_tensor[index_tensor, th.arange(len(index_tensor))]
            ...
            composite_q_values = tuple(th.mm(t, th.tensor(self.weights_vector, dtype=th.float).view(-1, 1)) for t in
