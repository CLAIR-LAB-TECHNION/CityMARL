...
class MultiPerspectiveCritic(BaseModel):
    """
    Critic network(s) for SACD.
    It represents the action-state value function (Q-value function).
    Compared to A2C/PPO critics, this one represents the Q-value
    and takes the continuous action as input. It is concatenated with the state
    and then fed to the network which outputs m values: Q(s, a) where m is the number of reward components.
    ...
    :param n_reward_components: Number of reward components
    """
